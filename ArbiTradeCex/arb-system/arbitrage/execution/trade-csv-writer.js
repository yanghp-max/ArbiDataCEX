...
const CSV_COLUMNS = [
  ...
  'lat_receive_ms',
  'lat_ws_transit_ms',
  'lat_decision_to_order_ms',
  'lat_ws_push_to_order_ms',
  'lat_receive_to_order_ms',
  'lat_price_age_at_order_ms',
  'lat_stage_calc_ms',
  'lat_stage_account_ms',
  'lat_stage_reserve_ms',
  'lat_stage_queue_ms',
  'lat_stage_fresh_tick_ms',
